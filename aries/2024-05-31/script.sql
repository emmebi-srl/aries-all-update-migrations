...
INSERT INTO cliente_promemoria_segnaposto (id_cliente_promemoria_configurazione, nome, descrizione) VALUES
	...
	(1, '{customer_name}', 'Ragione sociale cliente'),
	(1, '{date}', 'Data evento'),
	...
	(2, '{customer_name}', 'Ragione sociale cliente'),
	...
	(3, '{customer_name}', 'Ragione sociale cliente'),
	...
	(4, '{customer_name}', 'Ragione sociale cliente'),
	(4, '{date}', 'Data rinnovo'),
	...
	(5, '{customer_name}', 'Ragione sociale cliente'),
	...
	(7, '{customer_name}', 'Ragione sociale cliente'),
