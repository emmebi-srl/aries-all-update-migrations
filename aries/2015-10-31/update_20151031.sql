DROP TABLE IF EXISTS utente_devices; 

DROP PROCEDURE IF EXISTS sp_apiUtenteDevicesInsertOrUpdate; 


ALTER TABLE `evento`
	ADD COLUMN `Stato_notifica` TINYINT NULL DEFAULT '1' AFTER `Data_sveglia`;
...
SET 
	Descrizione = 'Nuovi eventi',
	Abilitato = 1, 
	rif_applicazioni = 'new_event',
	id_traduzione = 1;
